function IlustratorAuth() {
    return (
        <div className="ml-5 hidden lg:block lg:w-[380px] lg:my-auto lg:mx-auto lg:h-[630px] lg:relative">
            ...
            <img className="absolute left-3 top-3" src="images/logo-large.svg" alt="logo" />

            <img className="h-[630px] rounded-2xl" src="images/illustration-authentication.svg" alt="illustration-authentication" />
